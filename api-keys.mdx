---
title: "API Keys"
description: "Learn how to create and manage API keys for authenticating with Tembo's API"
---

# API Keys

API keys provide a secure way to authenticate with Tembo's API endpoints. They allow you to programmatically interact with Tembo from external applications, scripts, or integrations.

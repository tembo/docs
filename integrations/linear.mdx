...
Tembo maps Linear activity to workflow triggers (use a `linear.*` naming convention in your `triggerName`). The Integrations page in the app shows the live set enabled for your org. Supported events:

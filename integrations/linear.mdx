...
Model Context Protocol is a standardized way for AI applications to connect to external data sources and tools. With MCP, agents can query Linear issues, access project data, and retrieve workspace information in real-time while solving problems.
...
- **Access project context** - Retrieve project details, cycles, and milestones
- **Check issue relationships** - Understand dependencies and related issues
- **Read comments and activity** - Access the full history and discussion on issues

This enables agents to make more informed decisions when implementing features or fixes, as they have direct access to your issue tracker and can understand the broader context of the work being done.

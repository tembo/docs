...
- **Update key**: Run `/setup key:YOUR_NEW_API_KEY` (replaces existing key)
- **Remove key**: Run `/unregister` to delete your stored key
- **Security**: Keys are AES-256-GCM encrypted and never shared between users
...
- Create a issue in the bot's [repo](https://github.com/mezotv/tembo-discord-bot/issues) if the issue persists

...
icon: "); -webkit-mask-image: url('/images/raycast.svg'); mask-image: url('/images/raycast.svg');/*"
---
...
Be specific: include file paths, standards, or patterns (e.g., "Fix memory leak in workers/job-processor.ts" not "Fix the bug"). See the [Prompting Guide](/prompting-guide) for detailed tips.

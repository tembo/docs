...
<Accordion title="Require personal GitHub accounts">
    Workspace admins can require every member to connect their personal GitHub account before starting sessions. Enable **Require personal GitHub accounts** under **Session requirements** in [Workspace settings](https://app.tembo.io/settings/workspace).
  </Accordion>

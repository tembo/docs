...
<AccordionGroup>
  <Accordion title="Attribution">
    By default, PRs and commits are made under the Tembo bot account. Connect your personal GitHub account in your [Tembo user settings](https://app.tembo.io/settings) to be added as a co-author on commits from your sessions.

    To have commits authored as you instead of the bot, turn off **Include Tembo in commit attribution** in **Settings > Preferences**, under **Code**. This preference is only available after you connect a personal GitHub account.

    Org admins can require this: turn on **Require personal GitHub accounts** under **Session requirements** in [workspace settings](https://app.tembo.io/settings/workspace) to block members from starting sessions until they connect a personal GitHub account.
  </Accordion>

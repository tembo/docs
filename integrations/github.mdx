...
If automation triggers aren't firing from GitHub events:

1. **Verify webhook subscription** - Check the Integrations page to see which events are enabled
2. **Check GitHub App permissions** - Ensure the GitHub App has permissions for the events you need
3. **Review organization settings** - Some organizations restrict third-party app access; verify with your GitHub admin
4. **Contact support** - If you need additional events beyond the standard set, contact support@tembo.io

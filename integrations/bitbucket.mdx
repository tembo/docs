...
Tembo listens to common Bitbucket events and maps them to workflow triggers (reference them as `bitbucket.<category>` in your `triggerName`, e.g., `bitbucket.pull_request.opened`). Supported categories include:

- Pull request events: opened, closed/merged, reopened, draft/ready, edits

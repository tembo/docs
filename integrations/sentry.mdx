---
title: 'Sentry'
description: 'Connect dba to Sentry to automatically fix issues in your application'
icon: 'cloud'
---

## Sentry integration

dba seamlessly integrates with [Sentry](https://sentry.io), an industry-leading error monitoring platform, to provide automatic issue resolution for your applications.
...
## How dba and Sentry work together

When you connect Sentry to dba, our system:

1. Receives error alerts from your Sentry projects
2. Uses AI to analyze the error details and understand the root cause
3. Creates actionable issues in dba with appropriate severity levels
...
- Admin privileges in dba and Sentry

### Connection Steps

1. **Navigate to Integrations**

   - In your dba dashboard, go to your organization settings
   - Select the "Integrations" tab
   - Click on the "Connect" button next to Sentry

2. **Authorize Connection**

   - You'll be redirected to Sentry to authorize dba
   - Grant the required permissions to allow dba to:
     - Read error data
...
3. **Configure Project Mappings**
   ...
   - This mapping allows dba to create pull requests with fixes for your errors
   - Select the appropriate GitHub repository for each Sentry project you want to monitor

## Using the Integration

After successfully connecting Sentry, dba will automatically:

- Monitor incoming errors from your Sentry projects
- Create new issues in dba when errors occur
...
The Sentry integration uses secure OAuth2 authentication and all communication is encrypted. dba only requests the minimum permissions needed to function:

- Read access to error data
- Webhook event reception
- Access to project information

No sensitive application data beyond what's included in error reports is accessed or stored by dba.
...
2. **Check Project Mappings**
   ...
   - Without proper mapping, dba cannot create solution PRs.
...
4. **Contact Support**
   - If issues persist, contact our support team through the dba dashboard

## Disconnecting Sentry

To disconnect the Sentry integration:

1. Go to your organization settings in dba
2. Select the "Integrations" tab
...
**Q: Does dba need access to my source code?**
A: dba needs access to your GitHub repository to understand the code context and to create pull requests with fixes.
...
A: dba can analyze and suggest fixes for most popular programming languages, including JavaScript, Python, Ruby, Java, Go, and more.

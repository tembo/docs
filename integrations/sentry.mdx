...
Tembo listens to Sentry issue lifecycle events and maps them to workflow triggers (reference them as `sentry.<event>` in your `triggerName`). The Integrations page in the app shows the live set enabled for your org. Supported events:

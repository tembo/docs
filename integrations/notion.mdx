...
<Steps>
  ...
  <Step title="Authorize">
    Authorize Tembo to access your Notion account. You'll be prompted to grant access to your Notion workspaces. You'll be redirected back to the Integrations page when complete.
  </Step>
...
- **Read-only operations** - Currently provides read access to content (write operations may be added in future updates)

# Future Features

The Notion integration is in active development. Upcoming features may include:

- Automated documentation updates
- Content synchronization triggers
- Enhanced database manipulation
- Integration with Notion's API webhooks
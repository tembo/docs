...
Tembo listens to common GitLab events and maps them to automation triggers (reference them as `gitlab.<category>` in your `triggerName`, e.g., `gitlab.merge_request.opened`). The Integrations page in the app shows the live set enabled for your org. Supported events:

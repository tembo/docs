...
1. **Create a Merge Request** - Opens an MR with the proposed fix or improvement
2. **Add Context** - Includes a detailed description of what was changed and why
3. **Request Review** - Assigns the MR for team review following your repository's workflow

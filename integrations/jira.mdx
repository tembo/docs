...
<AccordionGroup>
  <Accordion title="Tembo not responding to labels">
    Verify the label is exactly "Tembo" (case-sensitive). Confirm you installed using the dedicated standard Jira user. Check integration status on the [Integrations page](https://app.tembo.io/integrations).
  </Accordion>

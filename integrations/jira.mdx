...
Tembo maps Jira activity to workflow triggers (use a `jira.*` naming convention in your `triggerName`). Common trigger sources include:

- Issue assignment or label application (e.g., a `Tembo` label)
- Status transitions when paired with labels/assignment

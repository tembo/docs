...
Tembo reacts to Slack interactions and maps them to workflow triggers (use a `slack.*` naming convention in your `triggerName`, e.g., `slack.app_mention`). The Integrations page in the app shows the live set enabled for your org. Supported events:
...
See Workflow Automations for how to create triggers from Slack events.
## Status Updates

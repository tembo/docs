...
<Warning>
  **AI-Generated Content Disclaimer**
  ...
  Tembo uses large language models (LLMs) to power its coding agents. While these agents are designed to assist with software engineering tasks, they may occasionally generate inaccurate, incomplete, or incorrect responses. Always review code changes, pull requests, and suggestions carefully before merging or deploying. Use your best judgment and verify critical changes through your standard code review process.
</Warning>

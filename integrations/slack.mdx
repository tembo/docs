...
<AccordionGroup>
  ...
  <Accordion title="Link PRs to Tembo instead of the source provider">
    By default, the completion button on a Slack PR notification reads **View PR** and opens the pull request on its source provider (GitHub, GitLab, or Bitbucket). In **Settings > Review**, under **Pull request defaults**, enable **Open Slack review links in Tembo** to change the button to **Review on Tembo** and open the PR in Tembo's review experience instead.
  </Accordion>
</AccordionGroup>

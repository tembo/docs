...
Tembo reacts to Slack interactions and maps them to workflow triggers (use them under a `slack.*` naming convention in your `triggerName`, e.g., `slack.app_mention`). Common trigger sources include:

- App mentions (e.g., `@tembo ...`)
- Slash commands (configured in your Slack app)
- Message actions and thread replies (contextual follow-ups)

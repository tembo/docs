...
- **`agent=`** - Specify which AI agent and model to use
  - Example: `agent=claudeCode:claude-4-5-sonnet`, `agent=codex:gpt-5-medium`
  - Available agents: `claudeCode`, `codex`, `opencode`, `amp`, `cursor`
  - See [Agents documentation](/features/agents) for full list of models

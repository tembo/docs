...
Tembo reacts to Slack interactions and maps them to workflow triggers (use a `slack.*` naming convention in your `triggerName`, e.g., `slack.app_mention`). Supported events:

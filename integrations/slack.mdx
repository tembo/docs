...
<Steps>
  ...
  <Step title="Authorize Slack Permissions">
    Authorize Tembo to access your Slack workspace. Permissions include reading messages (for context), sending messages and status updates, handling slash commands, and adding reactions. You'll be redirected back when authorization is complete.
  </Step>

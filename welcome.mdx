...
- **Fixes production bugs** — Monitors error tracking tools like Sentry and automatically fixes errors with simple code commits.

- **Implements from issues** — Assign issues from Linear, Jira, etc. to Tembo and it writes code to solve the issue, whether it's a bug, a feature, or a refactor.

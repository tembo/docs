...
**The unified interface for background coding agents.**

Any coding agent. Any model. Create and execute engineering tasks from any part of your stack, always with full context.

...
2. **Execution** - Tembo analyzes the codebase using your configured [agent](/features/coding-agents) and generates a solution in an isolated [sandbox environment](/features/sandbox-environment)
...
See [Agents](/features/coding-agents) for detailed information on each agent and how to choose the right one for your tasks.

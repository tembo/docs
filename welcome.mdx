---
title: 'What is Tembo?'
description: 'Delegate work to coding agents that ship features, review code, and handle tasks from Slack, Linear, and more.'
icon: 'sparkles'
---
...
- **Automate repetitive work** — Set up [automations](/features/automations) to handle recurring tasks with full MCP support.

- **Multi-repository support** — Spin off tasks that open PRs across multiple repositories when needed.
...
| **Communication**              | [Slack](/integrations/slack), [Discord](/integrations/discord), [Raycast](/integrations/raycast)       |

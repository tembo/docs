...
2. **Execution** - Tembo analyzes the codebase using your configured [agent](/features/agents) and generates a solution in an isolated [sandbox environment](/features/sandbox-environment)

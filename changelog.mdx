...
<Update label="2025-11-06" tags={["Platform"]}>

## Platform Improvements

Improved task processing reliability, by enhancing the stability of our task queue system and preventing bottlenecks when handling large volumes of tasks.

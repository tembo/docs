...
headers stay visible, long folder chains are collapsed into cleaner file tree
paths, and each task now shows pull request checks so it’s easier to spot what
is failing.

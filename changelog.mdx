...
## Better diffs in tasks

Task diffs are now easier to get to and easier to scan, including a dedicated
**View diff** action from the task header.
...
## Automations template library in-app

Browse and preview automation templates directly from the **Automations** page,
so you can start from a working template instead of building from scratch.

## Usage history improvements

The **Usage** page now includes a clearer usage chart plus a credit usage
history list, making it easier to understand where credits are going.

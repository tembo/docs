...
<Update label="2026-01-12" tags={["Models"]}>

## GLM 4.7 Model Support

Added support for **GLM 4.7**, a new AI model now available for your Tembo tasks. GLM 4.7 is accessible through the platform without requiring your own API key.

To use GLM 4.7, select it from the model dropdown when creating or configuring tasks. See [Coding Agents](/features/coding-agents) for more information on available models.

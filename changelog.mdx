...
## Better task browsing

The tasks list has improved search and filtering, plus clearer navigation
between **Active**, **Archived**, and **All**.

## Automations list upgrades

The automations list is now easier to scan and search, with improved
organization across **Active**, **Archived**, and **Templates**, plus faster
template-based creation.

## Sonnet 4.6 model support

Sonnet 4.6 is now available in Tembo as a model option.

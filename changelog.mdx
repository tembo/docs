...
<Update label="2025-09-05" tags={["Image Support", "File Mentions", "Claude Code", "Pull Requests"]}>

## Enhanced Image Support
Improved image upload functionality with better signed URL handling for reliable image attachments in tasks and conversations.

Key improvements include:
- Fixed image upload reliability with regenerated signed URLs
- Support for multiple image formats (JPEG, PNG, WebP, SVG, GIF, BMP, TIFF)
- Real-time upload progress indicators
- Improved error handling and validation
- Seamless drag-and-drop and paste functionality
...
Enhanced integration with Claude Code for better conversation continuity and development workflow.

- Support for conversation history continuation
- Improved context handling between sessions
- Better integration with development tools and workflows

## Pull Request Settings Improvements
Enhanced pull request configuration with better control over automation and mentions.

- Improved mention author settings in PR configurations
- Enhanced bot integration controls
- Better draft PR handling and workflow management
- Streamlined PR settings interface

...
## Image Support
We support images now. Works from Linear too.
...
- Smart autocomplete
- Works from Tembo UI and Linear
- Visual indicators for different mention types
- Context awareness in conversations

## Agent Integration
Integration with agent for better conversation continuity and development workflow.

- Support for conversation history continuation
- Context handling between sessions
- Integration with development tools and workflows

## Pull Request Settings
Pull request configuration with better control over automation and mentions.

- Mention author settings in PR configurations
- Gemini code assist as a review bot
- Draft PR handling and workflow management
- PR settings interface improvements

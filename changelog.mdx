...
<Update label="2024-12-20" tags={["Task Prioritization", "CI/CD", "Automation"]}>
...
<Update label="2024-12-13" tags={["Pull Requests", "Feedback", "Models"]}>
...
<Update label="2024-12-06" tags={["Linear", "Onboarding", "Stability"]}>

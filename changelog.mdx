...
<Update label="2025-11-03" tags={["Documentation", "MCP", "Workflows", "Integrations"]}>

This update focuses on significant documentation improvements and new features:

## Documentation Enhancements

### MCP Servers Documentation

Complete documentation for Model Context Protocol (MCP) servers, enabling enhanced AI capabilities:

- Comprehensive guide on configuring and using MCP servers
- Integration with Sentry for automated error handling
- MCP tools access within GitHub workflows
- Hook configuration for MCP servers

Learn more: [MCP Servers](/features/mcp-servers)

### Workflows & Automations

New comprehensive documentation for Tembo's automation capabilities:

- Detailed guide on setting up workflows
- Scheduling and triggering automated tasks
- Best practices for automation

### Integration Documentation Updates

Enhanced documentation across multiple integrations:

- **Sentry**: Expanded integration guide with Model Context Protocol details
- **GitHub**: Improved pull request workflow documentation with better structure
- **Slack**: Updated agent options to reflect currently available agents
- **Linear**: Enhanced repository linking documentation

### Sandbox Environment

Added Nix ecosystem support documentation, expanding development environment capabilities.

## Other Improvements

- Updated agent references across documentation to match current available options
- Refined messaging for automation features
- Various documentation structure and readability improvements

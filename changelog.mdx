...
Assign tasks and get PRs directly from Slack (see our [launch tweet](https://x.com/tembo_io)).

![Slack Integration](/images/slack-integration.png)

## Multi-Agent Support

Select an agent to tackle your task – Claude Code, Cursor, Codex, we've got them all (almost).

![Multi-Agent Support](/images/multi-agent-support.png)

## New Design

Slowly coming together, piece by piece. Feels way smoother already. Let us know what you think :)

![New Design](/images/new-design-light.png)
![New Design Dark Mode](/images/new-design-dark.png)

And there's lots more — hop into the app and play around.

— benja

still reading?? is this mode something you want? ;)

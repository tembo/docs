...
<Update label="2025-11-03" tags={["Documentation", "MCP", "Integrations"]}>

## Documentation Improvements

We've significantly enhanced our documentation to help you get the most out of Tembo:

### MCP Servers Documentation

Added comprehensive documentation for Model Context Protocol (MCP) servers, explaining how to extend your AI agents with additional tools and integrations. The new [MCP Servers guide](/features/mcp-servers) covers:

- Built-in MCP servers (Tembo, Playwright, Context7)
- Integration-specific servers (GitHub, Linear, Sentry)
- Custom MCP server configuration
- Best practices and troubleshooting

### Enhanced Integration Guides

Improved documentation across multiple integrations:

- **Sentry** - Added detailed MCP server integration documentation, explaining how agents can directly query error data and stack traces during task execution
- **Linear** - Enhanced repository selection and configuration guidance, including multi-repository workflows
- **GitHub** - Improved documentation structure and added clearer explanations of pull request workflows
- **Slack** - Updated agent options to reflect currently available agents

### Sandbox Environment Updates

- Added documentation for Nix ecosystem support in sandboxes
- Enhanced environment capabilities documentation

### Additional Updates

- Improved hooks documentation with MCP server configuration examples
- Enhanced agent documentation with current available agents
- Better organization and clarity across all integration guides

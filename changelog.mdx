...
<Update label="2025-10-02" tags={["Slack", "Raycast", "Integrations", "Documentation"]}>

## Agent Selection for Slack

Added agent selection capability to the Slack integration, giving you more control over which AI agent handles your tasks.

You can now specify which agent to use when creating tasks via Slack with the new `agent=` parameter:
- Example: `@tembo create a task to fix the login bug agent=claudeCode`
- Example: `@tembo implement user profile page agent=codex`

More agents coming soon to give you even more flexibility in how Tembo tackles different types of tasks.

Learn more about the [Slack integration](/integrations/slack).

## Raycast Documentation Updates

Improved documentation examples in the Raycast integration to provide clearer guidance on creating tasks with natural language.

Updated AI command examples to be more specific and actionable, helping you get better results when interacting with Tembo through Raycast AI.

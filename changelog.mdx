...
<Update label="2024-12-20" description="v1.3.0" tags={["AI Agent", "Workflows", "Task Management"]}>
...
<Update label="2024-12-13" description="v1.2.0" tags={["AI Agent", "Feedback", "Model Selection"]}>
...
<Update label="2024-12-06" description="v1.1.0" tags={["Linear", "Onboarding", "Stability"]}>

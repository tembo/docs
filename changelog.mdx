...
<Update label="2025-11-22" tags={["Workflows", "Jira", "Onboarding", "UI"]}>

## Automated Agent Rules Workflow

Introduced a new automated workflow that generates and maintains agent rules daily. This workflow helps keep your coding standards and project conventions up-to-date automatically, ensuring consistent code quality across your team.

## Jira Multi-Repository Selection

Enhanced Jira integration now supports multi-select for repositories. You can now associate multiple repositories with a single Jira project, making it easier to manage tasks across your codebase.

## Onboarding Improvements

Fixed scroll shadow visibility during stack selection, improving the visual polish of the onboarding experience and making it easier to navigate through available technology stacks.

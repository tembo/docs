...
The tasks list now makes it easier to find what you need with improved search
and filtering (including clearer Active/Archived/All navigation).

## Automations list upgrades

Automations now have a cleaner list experience with better search, improved
organization (Active/Archived/Templates), and faster creation from templates.

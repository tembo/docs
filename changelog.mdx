...
## Early access: official Slack MCP

Get early access to the official Slack MCP server—give it a try now. Connect
Slack, enable it for your agent, and let Tembo use Slack tools during tasks.

Learn more: [MCP Servers](https://docs.tembo.io/features/mcp-servers) and [Slack integration](https://docs.tembo.io/integrations/slack)

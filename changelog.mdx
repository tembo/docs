...
Tembo now supports Model Context Protocol (MCP) servers, extending your agents with additional tools and capabilities. Built-in servers include:

- **Tembo MCP** - Core Tembo tools for creating sub-issues and sending Slack messages
- **Playwright** - Browser automation and web testing capabilities
- **Context7** - Enhanced context management and search

You can also configure custom MCP servers to add your own integrations. Learn more in our [MCP Servers documentation](/features/mcp-servers).

## Enhanced Integration Documentation

We've significantly improved documentation for our integrations:

- **Sentry** - Added comprehensive MCP integration details and troubleshooting guides
- **GitHub** - Enhanced documentation structure with better organization
- **Linear** - Improved repository linking and integration setup instructions
- **Slack** - Updated agent options and integration workflows

## Sandbox Improvements

- Added Nix ecosystem support for better package management
- Enhanced hook configuration with MCP server support

## Additional Improvements

- Updated agent references across documentation to reflect currently available agents
- Improved documentation structure for better discoverability
- Various bug fixes and documentation polish

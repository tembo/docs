...
<Update label="2025-11-03" tags={["Documentation", "MCP", "Linear"]}>

Highlights since the last update:

## Enhanced Documentation

Comprehensive documentation improvements across the platform to help you get the most out of Tembo:

- **MCP Servers** - New documentation for [Model Context Protocol servers](/features/mcp-servers), including built-in servers (Tembo, Playwright, Context7) and how to configure custom MCP servers
- **Workflows & Automations** - Detailed guides on setting up automated workflows to trigger Tembo on a schedule
- **Integration Guides** - Enhanced documentation for all integrations with clearer setup instructions and troubleshooting tips
- **Agent Configuration** - Updated agent documentation reflecting all currently available agents (Claude Code, Codex, Opencode, Amp, Cursor)

## Linear Integration Improvements

Improved repository selection workflow when assigning Linear issues to Tembo:

- **Interactive Repository Selection** - Choose which repositories to work on when assigning issues
- **Default Repository Settings** - Configure a default repository in Linear integration settings for faster task creation
- **Multi-Repository Support** - Select multiple repositories for tasks that span across your stack
- **Clearer Status Updates** - Better progress tracking and status updates on Linear issues

## Sandbox Environment Updates

Enhanced sandbox capabilities:

- **Nix Ecosystem Support** - Added support for the Nix package manager and ecosystem tools
- **Improved Documentation** - Detailed guides on sandbox environment capabilities, security model, and best practices

## Sentry Integration Enhancements

Improved Sentry integration documentation:

- **MCP Server Details** - Documentation on Sentry MCP tools available to agents
- **Enhanced Setup Guide** - Clearer instructions for connecting Sentry to Tembo
- **Best Practices** - Guidelines for optimal error tracking and automatic issue resolution

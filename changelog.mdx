...
<Update label="2025-11-06" tags={["Platform", "Bug Fixes"]}>

## Platform Improvements

Improved task processing reliability by removing insert operations that were causing issues with maximum task limits. This change enhances the stability of our task queue system and prevents potential bottlenecks when handling large volumes of tasks.

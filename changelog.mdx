...
<Update label="2024-12-20" description="v1.3.0" tags={["Task Prioritization", "CI/CD", "Automation"]}>
...
<Update label="2024-12-13" description="v1.2.0" tags={["Pull Requests", "Feedback", "Models"]}>

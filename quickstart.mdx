...
<Steps>
  ...
  <Step title="Review the PR">
    Tembo works in a [sandbox](/features/sandbox/overview) and writes the code. Review the diff in the session's **Changes** tab, then click **Open PR** when you're ready, or ask Tembo to open one for you. Once it's open, mention `@tembo` in PR comments to request changes.
  </Step>

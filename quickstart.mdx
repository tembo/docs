...
<Steps>
  ...
  <Step title="Create a task">
    Open the [Tembo Dashboard](https://app.tembo.io) and click **New Task**. Pick one or more repositories, choose your [coding agent](/features/agents#coding-agent), and describe the work. Tembo can also use connected integrations and [MCP servers](/integrations/mcp) for extra context during the task.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Coding Agents" icon="bot" href="/features/agents#coding-agent">

...
description: "Run any coding agent across your repos, tickets, and tools, with full visibility."
"og:title": "Tembo Documentation"
...
<CardGroup cols={3}>
  ...
  <Card title="Share artifacts" icon="panel-right-open" href="/features/artifacts">
    Review visual walkthroughs, reports, structured exports, and uploaded files.
  </Card>
...
<Tabs>
  <Tab title="Harnesses">
    ...
    | **Cursor** | Anthropic, OpenAI, Google, xAI | `claude-sonnet-4-6` |
    | **Opencode** | Anthropic, OpenAI, OSS | `claude-sonnet-4-6` |
    | **Amp** | Anthropic (auto-selected) | `auto` |
    | **Pi** | Anthropic, OpenAI, OSS | `claude-sonnet-4-6` |

    Codex and OpenCode also support `gpt-5.5`, `gpt-5.4`, `gpt-5.4-mini`, and `gpt-5.4-nano`.

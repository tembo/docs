...
For an issue titled "Add 'out of credit' banner to dashboard", Tembo posts a comment like:

> **📁 Relevant Code:** `Banner.tsx`, `UpgradeBanner.tsx`, `useCredits.ts` — with links to PRs that modified these files
>
> **💬 Slack Context:** Links to discussions in #product and #design where the feature was requested and design decisions were made
>
> **📚 Documentation:** Links to billing system docs, banner component specs, and upgrade flow pages
>
> **💡 Implementation Hints:** Start with `UpgradeBanner` as template, use `useCredits()` hook, reference PR #198 (trial expiration banner)

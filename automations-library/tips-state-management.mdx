...
- **Log state changes** — Log before/after values (e.g., `"State: v1.2.3 → v1.2.5"`) to trace issues
- **Add reset mechanism** — Support a `RESET_STATE` flag to clear state and start fresh for recovery

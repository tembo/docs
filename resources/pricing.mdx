...
Pro and Max can use overage billing so your work can continue after you use your monthly allowance. You can set a maximum overage limit to control spend. On Free, new sessions are blocked when the allowance is exhausted until you upgrade or purchase more usage on demand.
...
- **Free**: new sessions are blocked until you upgrade or purchase more usage on demand.
...
- **Free plan**: upgrade to Pro or Max for overages, or purchase more usage on demand
- **Pro and Max**: enable overage billing and set a monthly spend limit, or use auto-reload
- **Purchased usage**: does not expire
...
- You can still purchase more usage on demand at any time
...
- Volume pricing
- Custom AWS Bedrock and GCP Vertex AI configuration
- Dedicated support

...
- **Free**: 10 credits resupplied monthly, up to 3 users
...
Paid plans include overage billing so your work can continue after you use your monthly plan credits. You can set a maximum overage limit to control spend. On Free, sessions pause when credits are exhausted until an upgrade or an additional credit purchase. Free credits are resupplied monthly so free workspaces can return to the included free credit balance.
...
- **Free credits are resupplied monthly**

## Seat limits

Workspace seat limits are enforced when inviting users on paid plans:
...
Pro and Max workspaces allow a maximum of 10 members. Active custom plans are not capped by the default Free, Pro, and Max limits unless your agreement defines a custom limit.

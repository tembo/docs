...
Tembo notifies organization admins and owners by email and with a dashboard banner as usage approaches these limits:

- **80% of the monthly allowance** used
- **Monthly allowance exhausted**
- **On-demand usage started** (overages enabled)
- **80% of the on-demand spend limit** used
- **On-demand spend limit reached**

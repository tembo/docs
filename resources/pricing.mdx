...
- **Free**: $10 in one-time credits, up to 3 users
...
Paid plans include overage billing so your work can continue after you use your monthly plan credits. You can set a maximum overage limit to control spend. On Free, sessions pause when credits are exhausted until an upgrade or an additional credit purchase. Free credits are granted once when the workspace is created; they do not refill monthly.
...
- **Free credits are one-time credits**

## Seat limits

Workspace seat limits are enforced when inviting users:
...
Pending invitations count toward the seat limit until they are accepted, revoked, or expire. Active custom plans are not capped by the default Free, Pro, and Max limits unless your agreement defines a custom limit.

...
Pro and Max can use overage billing so your work can continue after you use your monthly allowance. You can set a maximum overage limit to control spend. On Free, new sessions are blocked when the allowance is exhausted until you upgrade or add usage.

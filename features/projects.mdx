...
<Note>
  Projects are available on every plan. The Free plan includes one active project per workspace. Upgrade in **Settings** > **Billing** to create more projects. Paid plans include unlimited projects.
</Note>
...
- If you are on the Free plan, your workspace does not already have an active project.
...
Deleting a project archives it and disables its refresh schedule. Running sessions are not affected. Archived projects do not count toward the Free plan's one-project limit, so you can create a replacement after deleting a project.

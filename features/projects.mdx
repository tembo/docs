...
- Default agent instructions included in every session started from the project
...
7. Optionally add **Default agent instructions** for sessions started from the project.
...
Add default agent instructions to include guidance, such as coding conventions or testing expectations, in every session started from the project. Tembo adds these instructions to the prompt for each session, in addition to any [workspace skills](/features/agent-skills) included in the project.

To add default agent instructions:

1. Open **Settings** > **Projects**.
2. Select the project.
3. Under **Session defaults**, add or edit **Default agent instructions**.

...
### Step 1: Tembo Creates Initial PR/MR
Tembo detects a Sentry error about unhandled database timeouts and creates a PR (or MR for GitLab) with a basic try-catch solution.

### Step 2: You Provide Feedback via Review
Using your Git provider's review feature (GitHub PR reviews or GitLab MR reviews), you add multiple comments:

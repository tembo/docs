...
| Tool | Version | Description |
|------|---------|-------------|
| **nix** | latest | Reproducible package manager and build system |

The Nix package manager provides reproducible builds and declarative development environments through Nix flakes:

- **Automatic detection**: If your repository contains a `flake.nix` file, Tembo can automatically detect and use your Nix development shell
- **Reproducible environments**: Ensure consistent tooling across development, CI/CD, and Tembo's sandbox
- **Custom tooling**: Install project-specific tools and dependencies that aren't available by default

...
| Tool | Version | Description |
|------|---------|-------------|
| **dotnet-sdk** | 9 | .NET SDK 9 for building C# and F# applications |
...
|-------------|-----|--------|------|---------------------|
| **Small** | 4 cores | 4 GB hard / 3 GB soft | 20 GB | No |
| **Large Full VM** | 4 cores | 8 GB | 100 GB | Yes |

<Note>
The Small sandbox enforces a **4 GB hard limit** and a **3 GB soft limit** on container memory. Tasks that exceed the hard limit will be terminated to protect overall system stability.
</Note>

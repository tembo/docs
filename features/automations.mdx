...
If you have Tembo slash commands enabled in your integration, pass the automation key as an argument.

```txt
/<tembo-command> <automation-key>
```

You can also include JSON payload context.

```txt
/<tembo-command> <automation-key> {"issue_url":"https://github.com/org/repo/issues/42"}
```

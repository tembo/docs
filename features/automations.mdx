...
Trigger an automation on demand from external systems or chat commands using its UUID.
...
You can trigger an automation programmatically using its UUID via our SDK or an [API request](/api/trigger-automation).

...
Each automation runs in a secure [sandbox](/features/sandbox-environment) with full repository access and your configured [MCP servers](/features/mcp-servers).

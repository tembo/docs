...
Tembo supports multiple AI agents to solve your software engineering tasks. Each agent has different capabilities, models, and configuration options.
...
- Configuration file support (CLAUDE.md)
...
- Configuration file support (AGENTS.md)
- Profile-based configuration
- Custom provider settings

**Best For:**
- Tasks requiring different reasoning depths
- Performance-sensitive operations
- Teams preferring OpenAI models
...
**Best For:**
- Teams wanting flexibility in model choice

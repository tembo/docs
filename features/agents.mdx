...
For each agent you configure, you pick the [coding agent](/features/coding-agents) (and model) that runs in the session it spawns — for example Claude Code with Sonnet 4.6, Codex with GPT-5.4, or Cursor. You can set a default per agent and override per task.

See [Coding Agents](/features/coding-agents) for the full list of supported agents and models.

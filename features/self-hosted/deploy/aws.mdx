...
## Step 1: Request AMI Access

Contact Tembo to have the AMI shared with your AWS account. You will need to provide:
...
Recommended instance type: **`m8i.xlarge`** (4 vCPU, 16 GB RAM). For heavier workloads, `m8i.2xlarge` or larger.
...
3. Choose an instance type (`m6i.xlarge` or equivalent)

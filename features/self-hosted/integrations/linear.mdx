...
## Step 4: Authorize the App on Your Workspace

1. Use your app's authorize URL (`https://linear.app/oauth/authorize?...`) or have a workspace admin install it from **Settings > API > OAuth Applications**

...
<Note>
  This integration connects the Supabase hosted platform. To query a database belonging to a self-hosted Supabase deployment, use the [Postgres integration](/features/self-hosted/integrations/postgres) instead.
</Note>

...
| Create visual reports and structured exports | Tembo artifacts |
...
**Create an artifact**: For complex work, Tembo can create an [artifact](/features/artifacts) such as an HTML walkthrough, incident timeline, CSV export, or security report that stays attached to the session.

---
title: 'Proxy'
description: 'One API key for all models. Connect your local coding tools through Tembo.'
---

Tembo Proxy gives you access to models from Anthropic, OpenAI, and Google through a single API key. No separate provider accounts needed. Available on all plans.

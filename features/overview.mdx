...
- Real-time signal ingestion from tools like Sentry and Linear (see [integrations](/integrations))
- A PR generation and PR review processing engine
- Custom [workflows and automations](/features/workflows) for scheduled and event-driven tasks
...
1. **Ingests Signals**\
   Pulls from error trackers and database metrics (e.g. Sentry, Postgres)
...
Tembo executes engineering work across five key areas:
...
- Create [automated workflows](/features/workflows) that run on schedules or triggers
- Handle routine maintenance, documentation updates, or custom analysis
- Build your own AI-powered automation for any repetitive engineering task
...
- **Create workflows** - Build custom automations for your team's unique needs
...
- **Automations:** Set up [workflows](/features/workflows) to handle recurring tasks automatically

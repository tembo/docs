...
<Warning>
Supported by [GitHub](/integrations/github) and [GitLab](/integrations/gitlab).
</Warning>
...
No additional configuration is required. Tembo detects lines containing "TODO" across supported repositories and turns them into actionable tasks.

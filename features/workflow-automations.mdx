...
- The exact event set comes from our current webhook handlers in the monorepo and may evolve. The Integrations page in the app shows the live list for your org.
- The GitHub list below reflects our current implementation; for other providers, see each integration page for the most up-to-date events. If you need an additional event (e.g., GitHub tag creation), reach out to hi@tembo.io.

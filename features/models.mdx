...
<Frame>
  <img src="/images/models/model-provider-toggle.png" alt="Expanded model row showing the Provider dropdown for switching between BYOK and Tembo Managed Inference" />
</Frame>

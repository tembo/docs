...
Once connected, Tembo shows your ChatGPT Codex usage under **Settings > Connected accounts**:

- Your plan (for example, **ChatGPT Plus** or **Pro**)
- Rate limit windows (5-hour, daily, or weekly) with percentage remaining and reset time
- Credit balance, for plans that include credits
- Monthly usage against your plan's limit
- Lifetime tokens, peak daily tokens, and current streak

Select the refresh icon on the usage panel to update it on demand.

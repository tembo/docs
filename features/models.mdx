...
BYOK inference costs $0 through Tembo. You can also connect a paid ChatGPT subscription on every Tembo plan, including Free, to use supported OpenAI models with Codex, OpenCode, or Pi. Sessions still use billable cloud VM compute, which draws from your workspace's [usage allowance](/resources/pricing).

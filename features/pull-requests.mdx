...
When a session is complete, Tembo opens a pull request. You review it, [mention Tembo](/features/mentioning-tembo) to iterate, and merge when ready.
...
<Note>
  Sessions started from the [Dashboard](https://app.tembo.io) are the exception: Tembo shows the diff in the session's **Changes** tab and waits for you to click **Open PR**, or ask it to open one, instead of opening it automatically.
</Note>

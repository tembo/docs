...
1. **Issue Triggered** - Either automatically detected from Sentry/database monitoring, or manually assigned via Linear tickets
...
**Manual Assignment:**
- **[Linear](/integrations/linear) tickets** assigned to Tembo

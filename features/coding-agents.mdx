...
**Cerebras via OpenAI-compatible API (no API key required)**
- `gpt-oss-120b`
- `qwen-3-32b`
- `llama-3.3-70b`
- `zai-glm-4.7`

**Fireworks AI via OpenAI-compatible API (no API key required)**
- `kimi-k2p5`
- `zai-glm-5`
- `minimax-m2p5`
...
Alternative agent supporting multiple model providers including Anthropic, OpenAI, Cerebras, and Fireworks AI.
...
- Cerebras: `gpt-oss-120b`, `qwen-3-32b`, `llama-3.3-70b`, `zai-glm-4.7`
- Fireworks AI: `kimi-k2p5`, `zai-glm-5`, `minimax-m2p5`

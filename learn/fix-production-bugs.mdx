...
<Tip>You can also use the **Prioritize Sentry Errors** template to get a daily ranked report of the most impactful bugs posted to Slack with Linear tickets created automatically.</Tip>
...
| Event | Description |
|-------|-------------|
| `sentry.issue.created` | New error detected |
| `sentry.issue.regression` | Previously resolved error reappeared |
| `sentry.issue.resolved` | Error marked as resolved |
| `sentry.issue.assigned` | Error assigned to a team member |
...
<CardGroup cols={2}>
  <Card title="Sentry integration" icon="circle-alert" href="/integrations/sentry">
    Full setup and configuration guide.
  </Card>
  <Card title="Automations" icon="repeat" href="/features/automations">
    Learn more about triggers, templates, and custom workflows.
  </Card>
</CardGroup>

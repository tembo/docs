...
<Steps>
  ...
  <Step title="Review and merge">
    You review the PR and use the [feedback loop](/features/mentioning-tembo) to iterate if needed. Merge when ready.
  </Step>
</Steps>
...
- **Review before merging**: Always review the PR. Use the [feedback loop](/features/mentioning-tembo) to refine the fix.

...
Go to [Automations](/features/automations) in your dashboard and use the **Automated PR Reviews** template, or create one from scratch.

**Trigger**: PR opened / PR updated
**[MCP Servers](/integrations/mcp)**: GitHub (or GitLab/Bitbucket)

...
<Steps>
  ...
  <Step title="Code written">
    A [coding agent](/features/agents#coding-agent) works in an isolated [sandbox](/features/sandbox-environment), implements the solution, and opens a [PR](/features/pull-requests) linked back to the original issue.
  </Step>

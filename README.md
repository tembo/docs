...
`Validate SDK examples` checks same-repository example-update PRs without secrets or live API calls. Fork PRs are excluded from the internal RunsOn runners. Required approval must be configured separately in GitHub branch rules.

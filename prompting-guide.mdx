...
**Bug Reports:** Steps to reproduce, expected vs actual behavior, error messages, environment details, links to error tracking.

**Feature Requests:** User story/use case, mockups if visual, success metrics, edge cases, dependencies.

**Refactoring:** Current state problems, desired end state, constraints (backward compatibility), specific files, related tech debt.

**Documentation:** What to document and why, target audience, existing docs to reference, examples to include, format preferences.
